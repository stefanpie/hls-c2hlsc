...
// Alternative SubBytes implementation for golden computation
void golden_SubBytes(state_t* state) {
...
int main() {
    ...
    // Apply the SubBytes function
    SubBytes(&state);

    // Apply the golden SubBytes function
    golden_SubBytes(&golden_state);
    ...
    if (compare_states(state, golden_state)) {
        printf("Test passed: The SubBytes function output matches the golden output.\n");
        return 0;
    } else {
        printf("Test failed: The SubBytes function output does not match the golden output.\n");
        return 1;
    }
}
